...
$router->post('/container/{id}/stock/weight', [ContainerController::class, 'setStockByWeight']);
$router->get('/container/{id}/stock/history', [ContainerController::class, 'stockHistory']);
